...
function(DownloadCEF platform version download_dir)
  ...
  if(NOT IS_DIRECTORY "${CEF_ROOT}")
    ...
    if(NOT EXISTS "${CEF_DOWNLOAD_PATH}")
      set(CEF_DOWNLOAD_URL_UNENCODING "http://opensource.spotify.com/cefbuilds/${CEF_DOWNLOAD_FILENAME}")
      string(REPLACE "+" "%2B" CEF_DOWNLOAD_URL "${CEF_DOWNLOAD_URL_UNENCODING}")
